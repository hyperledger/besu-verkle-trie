 ...
 * Verkle Trie structure. It implements the Node interface and represents a node
 * that contains no information or value.
 */
public class NullNode<V> implements Node<V> {
     ...
     * This constructor is protected to ensure that `NullNode` instances are only
