...
/**
 * A class responsible for hashing an array of Bytes32 using the SHA-256 (Secure
 * Hash Algorithm 256-bit) hashing algorithm.
 *
 * <p>
 * This class implements the Hasher interface and provides a method to commit
 * multiple Bytes32 inputs using the SHA-256 hashing algorithm.
 * It utilizes the Java built-in MessageDigest for SHA-256.
 */
public class SHA256Hasher implements Hasher<Bytes32> {
    /**
     * Commits an array of Bytes32 using the SHA-256 hashing algorithm provided by
     * the MessageDigest.
     *
