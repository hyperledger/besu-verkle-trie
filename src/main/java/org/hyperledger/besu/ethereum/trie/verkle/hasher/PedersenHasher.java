...
/**
 * A class responsible for hashing an array of Bytes32 using the pedersen commitment - multi scalar multiplication
 * vector commitment algorithm.
 *
...
public class PedersenHasher implements Hasher {
  /**
   * Commits an array of Bytes32 using the pedersen commitment - multi scalar multiplication vector commitment algorithm.
   *
